            ...
            <div class="fixed top-0 flex items-center justify-center w-full h-full p-3 md:p-0 md:relative">
                <form method="post" action="{{ url('/auth/register') }}"
                    ...
                    <div class="space-y-12">
                        ...
                        @endisset
                        <div class="pb-12 ">
                            <h2 class="text-2xl leading-7 text-gray-900">Inscription</h2>
                                ...
                                <div class="block" id="email-to-phone">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" required
                                            class="w-full p-2 text-sm focus-visible:bg-violet-100/40 focus-visible:outline-violet-500 focus-visible:outline-1 focus-visible:placeholder:text-violet-500 rounded-xl bg-stone-100"
                                            placeholder="Pseudo" name="pseudo" id="pseudo">
                                    </div>
                                </div>
                                <div class="block" id="email-to-phone">
                    ...
                    <div>
                        <button type="submit"
                            class="w-full p-3 my-2 text-sm text-white rounded-md bg-stone-950 hover:bg-stone-900">S'inscrire</button>
                        <a href={{ url('/connexion') }}
                            class="w-full text-sm rounded-md  text-stone-600 hover:text-violet-700">Se connecter</a>
                    </div>
                </form>
            </div>
        </div>
